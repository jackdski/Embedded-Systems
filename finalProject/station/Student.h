...
typedef struct Student{
    ...
    uint8_t HASBIKE;     //Boolean showing that an error has occurred with this student
...
void registerStudent(uint8_t newRFID[16]);

//This function will print out the registry of students
void printRegistry();
